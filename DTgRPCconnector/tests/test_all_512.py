#!/usr/bin/env python3
"""
Test with ALL dimension fields set to 512 - no upscaling, just consistent dimensions.
"""
...
# Build configuration - ALL dimensions set to 512 (no upscaling)
...
print('Testing with ALL dimensions = 512 (no upscaling)')
print('start=512, original=512, target=512')
...
try:
    ...
    if generated_images:
        ...
        with open('output/kitten_all512.png', 'wb') as f:
            f.write(generated_images[0])
        print('✓ Saved to output/kitten_all512.png')
