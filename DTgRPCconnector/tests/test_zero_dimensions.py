#!/usr/bin/env python3
"""
Test WITHOUT start_width/start_height - let server figure it out.
"""
...
print('Fields: NO start_width/start_height - letting server decide')
...
try:
    ...
    if generated_images:
        ...
        with open('output/kitten_zero_dimensions.png', 'wb') as f:
            f.write(generated_images[0])
        print('✓ Saved to output/kitten_zero_dimensions.png')
